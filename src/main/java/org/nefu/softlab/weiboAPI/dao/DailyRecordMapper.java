...
import org.nefu.softlab.weiboAPI.dao.provider.DailyRecordSqlProvider;
...
public interface DailyRecordMapper {
    ...
    @Insert({
        ...
        "recordnumber, recordsize, date, ",
        "saveTimestamp)",
        "values (#{rid,jdbcType=CHAR}, #{socket,jdbcType=VARCHAR}, ",
        "#{recordnumber,jdbcType=INTEGER}, #{recordsize,jdbcType=DOUBLE}, #{date,jdbcType=CHAR}, ",
        "#{savetimestamp,jdbcType=VARCHAR})"
    })
